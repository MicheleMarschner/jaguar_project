    ...
    for group, members in groups.items():
        ...
        if run_cfg["build_model_soup"]:
            ...
            if wandb_run:
                ...
                table = wandb.Table(columns=["query", "pred", "true_label", "pred_label", "similarity"])
                ...
                wandb_run.log({f"visuals/soup_errors_{group}": table})
