...
python src/jaguar/experiments/experiment_setup.py --setup_name kaggle_deduplication --base_config base/kaggle_base --experiment_config _generated/kaggle_deduplication/closed_curated_traink_5_valk_1_p4
...
python src/jaguar/experiments/experiment_setup.py --setup_name kaggle_deduplication --base_config base/kaggle_base --experiment_config _generated/kaggle_deduplication/closed_curated_traink_8_valk_1_p4
